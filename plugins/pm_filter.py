        ...
        if total_results == 0:
            ...
            return await message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                        [[
                            InlineKeyboardButton('✧ ᴛᴀᴋᴇ ᴍᴏᴠɪᴇ ꜰʀᴏᴍ ʜᴇʀᴇ ✧', url ='https://t.me/+gHYy244ScxoxZjI1')
                        ]]
                    )
                )
...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         ...
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝  ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ​ ", url=f"https://t.me/+gHYy244ScxoxZjI1")]]), disable_web_page_preview=True
    )
...
async def next_page(bot, query):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⛔️  sᴜʙsᴄʀɪʙᴇ ᴏᴜʀ ᴄʜᴀɴɴᴇʟ ​ ⛔️", url="https://t.me/UHD_Tamil")
    ])
    try:
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('ꜱᴜʙꜱᴄʀɪʙᴇ  ᴍʏ  ᴄʜᴀɴɴᴇʟ', url="https://t.me/UHD_Tamil"),
        ],[
            InlineKeyboardButton('ɢʀᴏᴜᴘ', url="https://t.me/+gHYy244ScxoxZjI1"),
            InlineKeyboardButton('ᴄʜᴀɴɴᴇʟ', url="https://t.me/+lUNel84X54NkNTg1")
        ],[
            InlineKeyboardButton('ꜱᴜᴘᴘᴏʀᴛ', url="https://telegram.me/UHDxTamil"),
            InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇꜱ', url="https://t.me/UHD_Tamil")
        ],[
            InlineKeyboardButton('ʙᴀᴄᴋ​', callback_data='start')
        ]]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ʀᴇᴘᴏʀᴛ  ʙᴜɢꜱ  ᴀɴᴅ  ꜰᴇᴇᴅʙᴀᴄᴋ', url='https://t.me/+gHYy244ScxoxZjI1')
        ],[
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='start'),
        ...
        buttons = [[
                    InlineKeyboardButton("💶    ᴘʟᴇᴀsᴇ  ᴅᴏɴᴀᴛᴇ    💶", url="https://telegra.ph/")
                 ],[
                    InlineKeyboardButton("ʙᴀᴄᴋ", callback_data="start"),
                    InlineKeyboardButton("ᴄᴏɴᴛᴀᴄᴛ", url="https://t.me/GN24M")
                  ]]
        await client.edit_message_media(
            query.message.chat.id, 
            query.message.id, 
        ...
        await query.message.edit_text(
            ...
            btn = [[
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='start'),
            InlineKeyboardButton('ʜᴇʟᴘ', url='https://telegram.me/UHDxTamil')
            ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
