...
PICS = (environ.get('PICS', 'https://graph.org/file/2bf5bb32bbc4ee87099d7.jpg')).split()
NOR_IMG = environ.get("NOR_IMG", "https://telegra.ph/file/df85b2b9b5666d04d9b43.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://telegra.ph/file/23db53aac15816b101b2e.jpg")
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mrprince24gopriya:UHDxnobi@uhdxnobi.cjgwxuk.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "UHDxnobi")
...
#Auto approve 
CHAT_ID = [int(app_chat_id) if id_pattern.search(app_chat_id) else app_chat_id for app_chat_id in environ.get('CHAT_ID', '1291610043').split()]
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://telegram.me/UHD_Tamil')
MSG_ALRT = environ.get('MSG_ALRT', 'Join 🦄 @UHD_Tamil 🦄')
